const content = {
  ...
  format: {
    ...
    items: [
      ...
      "Foco em sair de cada aula entendendo o conceito de verdade",
      "Primeira aula gratuita, pagamento por aula sem compromisso de continuar",
    ],
  },
  ...
  modules: [
    {
      ...
      topics: [
        ...
        "Tuning de banco de dados SQL e NoSQL",
        "Race conditions em produção com alto volume",
        "Do zero à produção: todas as decisões arquiteturais",
        "Monolito em startup vs. microserviços no corporativo",
      ],
    },
    {
      ...
      topics: [
        ...
        "Guardrails e validação de outputs de agentes",
    ...
    },
    {
      title: "Arquitetura",
      topics: [
        "Design Patterns aplicados em sistemas reais",
        "CQRS e Event Sourcing",
        "Resiliência e tolerância a falha",
        "Segurança em aplicações de grande escala",
