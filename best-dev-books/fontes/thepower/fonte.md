...
- **Publicador/curador:** The Power Education
- **URL:** https://thepower.education/blog/tech/10-libros-de-programacion
- **Domínio:** thepower.education
...
- **Idioma:** `es`
- **Quantidade usada:** 13
- **Escopo:** Clássicos de construção de software, algoritmos e fundamentos.
- **Observações:** Fonte em espanhol. Lista numerada de dez itens mais três indicações de bônus, todas mantidas na ordem da página.
