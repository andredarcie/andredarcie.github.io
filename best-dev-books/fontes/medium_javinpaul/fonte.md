...
- **Publicador/curador:** javinpaul / Javarevisited (Medium)
- **URL:** https://medium.com/javarevisited/12-must-read-books-for-software-engineers-and-developers-27da9f88b19e
- **Domínio:** medium.com
- **Data de publicação/atualização identificada:** 2025-02-11
...
- **Idioma:** `en`
- **Quantidade usada:** 12
- **Escopo:** Fundamentos, design, ofício, algoritmos e história da programação.
- **Observações:** Mesmo autor da fonte `devto_javinpaul`, em publicação e lista distintas; há sobreposição parcial de títulos.
...
| # | Critério | Nota |
|---|---|---:|
| Q1 | Autoridade de quem produziu | 1 |
| Q2 | Método declarado | 0 |
| Q3 | Objetividade | 2 |
| Q4 | Datação | 1 |
| Q5 | Controle editorial do veículo | 0 |
| Q6 | Posição frente a outras fontes | 0 |
| Q7 | Autopromoção | 2 |

**Total: 6/14 · faixa aceitável.**
