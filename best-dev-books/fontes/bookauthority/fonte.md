...
- **Publicador/curador:** BookAuthority
- **URL:** https://bookauthority.org/books/best-software-engineering-books
- **Domínio:** bookauthority.org
...
- **Natureza:** `ranking_recomendacoes_especialistas`
- **Tipo de ordem:** `ranking_explicito`
- **Idioma:** `en`
- **Quantidade usada:** 10
- **Escopo:** Ofício, entrega, testes, agilidade e engenharia em escala.
- **Observações:** Ranking montado a partir de recomendações públicas de especialistas; a ordem exibida pela página foi preservada.
...
| Q2 | Método declarado | 2 |
| Q3 | Objetividade | 2 |
| Q4 | Datação | 0 |
| Q5 | Controle editorial do veículo | 0 |
| Q6 | Posição frente a outras fontes | 1 |
| Q7 | Autopromoção | 2 |

**Total: 9/14 · faixa aceitável.**
