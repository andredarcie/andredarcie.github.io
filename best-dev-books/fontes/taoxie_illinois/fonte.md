...
- **Publicador/curador:** Tao Xie / University of Illinois
- **URL:** https://taoxie.cs.illinois.edu/sereading.htm
- **Domínio:** taoxie.cs.illinois.edu
...
- **Idioma:** `en`
- **Quantidade usada:** 16
- **Escopo:** Modularidade, requisitos, arquitetura, estimativa e padrões.
- **Observações:** Página de leituras de pesquisa em engenharia de software; foram contados apenas os livros, não os artigos nem a coletânea de manuscritos de Dijkstra.
