...
- **Publicador/curador:** Bartłomiej Żyliński / Pask Software
- **URL:** https://pasksoftware.com/software-engineer-books/
- **Domínio:** pasksoftware.com
...
- **Idioma:** `en`
- **Quantidade usada:** 8
- **Escopo:** Ofício, carreira, entrevistas de system design e padrões de projeto.
- **Observações:** O autor apresenta os livros em ordem de colocação e destaca qual leria primeiro.
