...
- **Publicador/curador:** hackr.io
- **URL:** https://hackr.io/blog/best-programming-books
- **Domínio:** hackr.io
- **Data de publicação/atualização identificada:** 2025-01-30
...
- **Idioma:** `en`
- **Quantidade usada:** 10
- **Escopo:** Clássicos de programação, algoritmos e padrões de projeto.
- **Observações:** Página com links de afiliado; a numeração de 1 a 10 da própria fonte foi mantida.
...
| Q3 | Objetividade | 0 | Links de afiliado na própria lista.
| Q4 | Datação | 1 |
