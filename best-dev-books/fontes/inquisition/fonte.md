...
- **Publicador/curador:** inquisition.ca
- **URL:** https://inquisition.ca/fr/info/biblio_info.htm
- **Domínio:** inquisition.ca
...
- **Idioma:** `fr`
- **Quantidade usada:** 20
- **Escopo:** Construção, processo, sistemas operacionais, redes, banco de dados e UML.
- **Observações:** Fonte em francês, com 39 títulos de bibliografia; foram usados os 20 primeiros para comparabilidade.
