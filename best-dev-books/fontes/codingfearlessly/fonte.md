...
- **Publicador/curador:** Mindaugas Mozūras / Coding Fearlessly
- **URL:** https://codingfearlessly.com/recommended-software-engineering-books
- **Domínio:** codingfearlessly.com
...
- **Idioma:** `en`
- **Quantidade usada:** 15
- **Escopo:** Trilha por estágio de carreira: início, evolução, sistemas e gestão.
- **Observações:** A página organiza as indicações em cinco estágios de carreira; a ordem de exibição foi preservada.
