...
- **Publicador/curador:** Comment Devenir Développeur
- **URL:** https://www.comment-devenir-developpeur.com/blog/top-5-livres-a-lire-pour-tout-developpeurs-peu-importe-le-niveau
- **Domínio:** www.comment-devenir-developpeur.com
...
- **Idioma:** `fr`
- **Quantidade usada:** 5
- **Escopo:** Qualidade de código, carreira, entrevistas e padrões de projeto.
- **Observações:** Fonte em francês, com cinco indicações numeradas.
