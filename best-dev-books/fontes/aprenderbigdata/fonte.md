...
- **Publicador/curador:** Aprender BigData
- **URL:** https://aprenderbigdata.com/mejores-libros-de-programacion/
- **Domínio:** aprenderbigdata.com
- **Data de publicação/atualização identificada:** 2024-07-29
...
- **Idioma:** `es`
- **Quantidade usada:** 8
- **Escopo:** Programação geral, algoritmos, entrevistas e linguagens da JVM.
- **Observações:** Fonte em espanhol; foi usada a seção de programação e desenvolvimento de software.
