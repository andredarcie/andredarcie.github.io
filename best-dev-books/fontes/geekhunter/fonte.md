...
- **Publicador/curador:** GeekHunter
- **URL:** https://www.geekhunter.com/pt/blog/10-livros-de-programacao-que-vao-mudar-sua-carreira/
- **Domínio:** www.geekhunter.com
- **Data de publicação/atualização identificada:** 2025-03-20
...
- **Idioma:** `pt`
- **Quantidade usada:** 10
- **Escopo:** Código limpo, legado, padrões, fundamentos de hardware e entrevistas.
- **Observações:** Fonte em português; os títulos das edições brasileiras foram mapeados para o título canônico.
