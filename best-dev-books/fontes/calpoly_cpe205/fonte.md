...
- **Publicador/curador:** John Dalbey / California Polytechnic State University
- **URL:** https://users.csc.calpoly.edu/~jdalbey/205/syllabus.html
- **Domínio:** users.csc.calpoly.edu
- **Data de publicação/atualização identificada:** 2004
...
- **Idioma:** `en`
- **Quantidade usada:** 2
- **Escopo:** Processo, planejamento e sobrevivência de projetos de software em equipe.
- **Observações:** Foram usados os dois livros indicados no programa; o guia online de projetos em grupo não foi contado como livro.
...
| # | Critério | Nota |
|---|---|---:|
| Q1 | Autoridade de quem produziu | 2 |
| Q2 | Método declarado | 1 |
| Q3 | Objetividade | 2 |
| Q4 | Datação | 1 |
| Q5 | Controle editorial do veículo | 2 |
| Q6 | Posição frente a outras fontes | 0 |
| Q7 | Autopromoção | 2 |

**Total: 10/14 · faixa sólida.**
