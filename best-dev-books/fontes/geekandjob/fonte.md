...
- **Publicador/curador:** Geek&Job
- **URL:** https://blog.geekandjob.com/libri-per-programmatori/
- **Domínio:** blog.geekandjob.com
...
- **Idioma:** `it`
- **Quantidade usada:** 11
- **Escopo:** Fundamentos de computação, algoritmos, ofício e carreira.
- **Observações:** Fonte em italiano; a última indicação é apresentada como bônus e foi mantida na ordem da página.
