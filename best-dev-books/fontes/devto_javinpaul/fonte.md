...
- **Publicador/curador:** DEV Community / javinpaul (somadevtoo)
- **URL:** https://dev.to/somadevtoo/10-software-engineering-books-developers-should-read-in-2025-2kfk
- **Domínio:** dev.to
- **Data de publicação/atualização identificada:** 2025-01-14
...
- **Idioma:** `en`
- **Quantidade usada:** 10
- **Escopo:** Conselhos gerais, código, arquitetura, padrões e algoritmos.
- **Observações:** A lista é numerada de 1 a 10 e agrupada em cinco categorias; a ordem numérica foi preservada.
