...
- **Publicador/curador:** James Purtilo / University of Maryland
- **URL:** https://seam.cs.umd.edu/purtilo/435/textbooks.html
- **Domínio:** seam.cs.umd.edu
...
- **Idioma:** `en`
- **Quantidade usada:** 4
- **Escopo:** Livros-texto de engenharia de software para curso de graduação.
- **Observações:** A página indica livros de apoio ao projeto da disciplina, sem eleger um único obrigatório.
