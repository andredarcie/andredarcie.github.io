...
- **Publicador/curador:** Amigoscode
- **URL:** https://blog.amigoscode.com/p/9-books-every-software-engineer-should
- **Domínio:** blog.amigoscode.com
...
- **Idioma:** `en`
- **Quantidade usada:** 9
- **Escopo:** Qualidade de código, arquitetura, bancos de dados, sistemas distribuídos e DevOps.
- **Observações:** Lista numerada de nove itens, com ênfase no que o autor considera leitura obrigatória.
