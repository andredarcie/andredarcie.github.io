...
- **Publicador/curador:** Gergely Orosz / The Pragmatic Engineer
...
- **Idioma:** `en`
- **Quantidade usada:** 20
- **Escopo:** Carreira em engenharia, entrevistas e engenharia de software.
- **Observações:** A página reúne cerca de 112 livros em oito seções; foram usados os 20 primeiros. Mesmo autor da fonte `pragmatic_engineer_reading`, em página distinta.
