...
- **Publicador/curador:** Hack Reactor
- **URL:** https://www.hackreactor.com/resources/7-great-books-for-software-engineers-to-read/
- **Domínio:** www.hackreactor.com
- **Data de publicação/atualização identificada:** 2022-09-13
...
- **Idioma:** `en`
- **Quantidade usada:** 7
- **Escopo:** Entrevistas técnicas, qualidade de código, design e usabilidade.
- **Observações:** Foram usadas as sete recomendações principais; as sugestões extras de nicho no fim do artigo ficaram de fora.
...
| Q3 | Objetividade | 1 |
| Q4 | Datação | 1 |
| Q5 | Controle editorial do veículo | 1 |
