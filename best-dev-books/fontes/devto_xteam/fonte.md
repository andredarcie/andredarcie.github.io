...
- **Publicador/curador:** X-Team / DEV Community
- **URL:** https://dev.to/x-team/10-essential-programming-books-every-developer-should-read-3mmj
- **Domínio:** dev.to
- **Data de publicação/atualização identificada:** 2022-08-09
