...
- **Publicador/curador:** Mary Shaw / Carnegie Mellon University
- **URL:** https://www.cs.cmu.edu/~shaw/Edparts/sebook.htm
- **Domínio:** www.cs.cmu.edu
...
- **Idioma:** `en`
- **Quantidade usada:** 9
- **Escopo:** Arquitetura, requisitos, design, UML e engenharia de sistemas.
- **Observações:** Foram preservadas as nove recomendações da página, na ordem das categorias.
