...
- **Publicador/curador:** Squash.io
- **URL:** https://www.squash.io/24-influential-books-programmers-should-read/
- **Domínio:** www.squash.io
- **Data de publicação/atualização identificada:** 2023-06-02
...
- **Quantidade usada:** 20
- **Escopo:** Escrita de código, engenharia de software e mentalidade.
- **Observações:** A fonte possui 24 itens; foram usados os 20 primeiros.
