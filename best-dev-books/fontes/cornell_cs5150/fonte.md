...
- **Publicador/curador:** Cornell University
- **URL:** https://www.cs.cornell.edu/courses/cs5150/2025sp/references.html
- **Domínio:** www.cs.cornell.edu
- **Data de publicação/atualização identificada:** 2025
...
- **Quantidade usada:** 5
- **Escopo:** Engenharia em escala, embarcados, gestão de projetos e prática profissional.
- **Observações:** Foram usados os cinco itens da seção 'Books'; recursos online foram excluídos.
