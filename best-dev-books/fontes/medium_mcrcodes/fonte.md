...
- **Publicador/curador:** Manchester Codes (Medium)
- **URL:** https://medium.com/@MCRcodes/10-books-every-junior-developer-needs-to-read-42953d1d5889
- **Domínio:** medium.com
- **Data de publicação/atualização identificada:** 2018-06-18
...
- **Idioma:** `en`
- **Quantidade usada:** 10
- **Escopo:** Design orientado a objetos, aprendizado, JavaScript e fundamentos.
- **Observações:** Lista numerada de dez itens produzida por uma escola de programação.
