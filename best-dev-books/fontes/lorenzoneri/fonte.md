...
- **Publicador/curador:** Lorenzo Neri
- **URL:** https://lorenzoneri.com/i-migliori-libri-sulla-programmazione/
- **Domínio:** lorenzoneri.com
- **Data de publicação/atualização identificada:** 2021-05-31
...
- **Idioma:** `it`
- **Quantidade usada:** 12
- **Escopo:** Linguagens, especialização em IA e jogos, e competências profissionais.
- **Observações:** Fonte em italiano, dividida em livros de linguagens, de especialização e de competências profissionais.
