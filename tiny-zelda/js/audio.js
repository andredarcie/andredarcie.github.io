// Tiny Zelda — WebAudio chiptune engine v2
...
const Audio2 = (() => {
  const MUTE_KEY = 'tinyzelda_muted';
  ...
  const SONGS = {
    overworld: {
      bpm: 152, leadWave: 'p50', arpWave: 'p25', vib: true,
      lead: `C5/1.5 C5/.5 C5 G4  A4/1.5 A4/.5 A4 E4  F4 G4 A4 B4  C5/2.5 R/.5 G4/.5 G4/.5
             E5/1.5 D5/.5 C5 D5  E5 E5 D5 C5  B4/1.5 A4/.5 G4 A4  B4/2 G4/2
             A4 C5 F5/1.5 E5/.5  D5 F5 A5/2  G5/1.5 F5/.5 E5 D5  E5/2 C5/2
             F5 E5 D5 C5  D5/1.5 C5/.5 B4 G4  C5 G4 E4 G4  C5/3 R`,
      chords: 'C Am F/2 G/2 C  C Em F G  F Dm G C  F G C/2 G/2 C',
