...
Life Lab é uma arena de vida artificial feita com HTML, CSS e JavaScript puro, desenhada em three.js em vista isométrica. O mundo é um tabuleiro flutuando no céu: um bloco de bordas retas, com os biomas em cima e as laterais mostrando o corte da terra (franja de grama na cor do bioma daquela beirada, terra, argila e rocha). Pequenos organismos geométricos exploram o ambiente, enxergam de acordo com seu cone de visão, procuram comida e água, formam alianças e reproduzem com cortejo, gestação e nascimento.
...
- Fogueira: tribo com 4 ou mais membros acende uma ao anoitecer, no meio do bando e longe das poças (até 2 fogueiras no mundo). Perto da hora de deitar cada um vai para o seu lugar na roda, espera de frente para o fogo e dorme com os pés virados para ele. O fogo ilumina a roda (luz pontual laranja com tremor, brilho no chão) e, na sua claridade, a visão quase volta à do dia; o calor acelera a recuperação da energia e reduz o metabolismo do sono. Chuva apaga (e a tribo reacende depois); de manhã a chama morre em brasa e some.
- Reprodução com aproximação, cortejo, acasalamento, gravidez e parto. A gravidez dura 16 s e a barriga cresce devagar no começo e bem mais no fim; no último trecho a mãe anda gingando, com uma mão nas costas e a outra na barriga. O trabalho de parto (5,5 s) tem contrações em pé, com o corpo dobrado e as mãos nos joelhos; depois a mãe deita de costas, joelhos erguidos e afastados, e faz força em ondas, curvando o tronco e apertando os olhos. O bebê sai de cabeça, aos poucos, avançando a cada onda, na cor que o filhote vai ter; quando sai inteiro vira o filhote ali mesmo, deitado, que depois se levanta. A câmera de acontecimentos acompanha o parto desde o começo.
...
- Lagos com profundidade de verdade: o chão é uma malha que afunda em tigela (fundo em parábola, borda ondulada) onde há lago, com lama escura em volta. A água fica na altura que o volume manda — cheia, rente à margem; secando, desce dentro da tigela e deixa a lama exposta —, mais funda, escura e opaca no meio e rasa e transparente na beira, reflete a cor do céu (dourada no pôr do sol, escura à noite), tem ondulação e uma fita de espuma na margem. Quem entra na tigela desce junto com o chão.
- Transparência de quem tapa: árvore, cacto, pedra ou cabana que fica entre a câmera e um bicho esmaece suavemente até ficar translúcida enquanto ele estiver atrás, e volta a ficar sólida quando ele sai (`OcclusionFader`, conta feita no espaço da câmera).
- Qualidade visual: capim 3D em milhares de tufos instanciados (uma chamada de desenho), na cor do bioma e balançando com o vento no shader, sumindo sob poças e cabanas; sombra de contato macia no pé de bichos, árvores, pedras e moitas; degradê de oclusão na geometria de todo bloco (base escura, topo claro); névoa de profundidade na cor do horizonte, que dá perspectiva aérea ao tabuleiro; água com mapa de ondulação deslizante que faz o brilho tremular; nuvens fofas no céu em volta do tabuleiro, na cor da hora do dia; e chão com manchas e granulação.
- Acabamento visual: árvores e capim balançam com o vento (brisa sempre, vento forte com tempo fechado), sombras de nuvem atravessam o chão de dia, vaga-lumes piscam em volta das árvores à noite (a chuva espanta), pingos de chuva abrem anéis nas poças, os bichos têm olhos que piscam, fecham no sono e apertam no choro, e uma vinheta leve escurece os cantos. A sombra do sol anda em passos de um pixel do mapa de sombra, então não tremula ao passear com a câmera. Tudo que é animação decorativa para com "reduzir movimento" do sistema.
...
- O enquadramento inicial mostra **o tabuleiro inteiro, do maior tamanho possível**, em qualquer tela e orientação: a câmera mede os painéis da HUD e o `BoardFraming` procura posição e zoom juntos, com a silhueta do tabuleiro (o losango, a copa das árvores do fundo e a lateral do bloco) dentro da tela e sem encostar em painel. Fica no centro quando isso não custa tamanho; em tela pequena, onde a coluna da HUD atrapalha, desliza para o lado livre. Se a HUD muda de tamanho, o enquadramento desliza até o novo encaixe.
- **Roda do mouse** (em volta do cursor), **pinça** com dois dedos e os botões no canto dão zoom; aproximado, mova a câmera **arrastando**, com as **setas** ou com **WASD**. ⟲ volta ao mundo inteiro. Nomes e balões aparecem conforme os bonecos ficam grandes na tela.
